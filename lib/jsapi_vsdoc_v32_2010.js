...
esri.dijit.Attribution = function (options, srcNodeRef) {
    ...
    /// <param name="options" type="Object" optional="false">An object that defines the attribution options. View the options list for details.</param>
    /// <param name="srcNodeRef" type="Object" optional="false">HTML element where the time slider should be rendered.</param>
...
esri.layers.MapImage = function (options) {
    ...
    /// <field name="href" type="String">URL to returned image.  The image format must be of a type supported by the HTML img tag. Known Values: gif | jpg | png | bmp</field>
...
esri.layers.KMLLayer.prototype =
{
    ...
    setFolderVisibility: function (folder, trueOrFalse) {
        ...
        /// <param name="trueOrFalse" type="Boolean" optional="false">The visibility of the folder and all kml features within the folder.</param>
        /// <return type="none">none</return>
    },
...
esri.layers.WebTiledLayer = function (options, urlTemplate) {
...
esri.layers.WebTiledLayer.prototype =
{
...
esri.symbol.PictureMarkerSymbol = function (url, width, height) {
    ...
    /// <param name="height" type="Number" optional="false">Height of the image in pixels.  The default value is the actual height of the image.</param> = function (json) {
...
esri.symbol.SimpleFillSymbol = function () {
    /// <summary>Creates a new empty SimpleFillSymbol object.</summary> = function (style,outline,color) {
...
esri.symbol.SimpleLineSymbol = function () {
    /// <summary>Creates a new empty SimpleLineSymbol object.</summary> = function (style,color,width) {
...
esri.symbol.SimpleMarkerSymbol = function () {
    /// <summary>Creates a new empty SimpleMarkerSymbol object.</summary> = function (style,size,outline,color) {
...
esri.symbol.CartographicLineSymbol = function () {
    /// <summary>Creates a new empty CartographicLineSymbol object.</summary> = function (style,color,width,cap,join,miterLimit) {
...
esri.symbol.PictureFillSymbol = function (url, outline, width, height) {
    ...
    /// <param name="height" type="Number" optional="false">Height of the image in pixels.</param> = function (json) {
...
esri.symbol.TextSymbol = function (text) {
    ...
    /// <param name="text" type="String" optional="false">Text string for display in the graphics layer.</param> = function (text,font,color) {
...
esri.symbol.Font = function () {
    /// <summary>Creates a new Font object.  This constructor takes no parameters.</summary> = function (size,style,variant,weight,family) {
